	...
	return (
		<div className='flex z-30 justify-between items-center p-4 px-10
			...
			<div className='flex gap-10'>
				 <IoSearch className='text-[35px] text-gray-300 hover:bg-gray-700
				 	px-[3px] pb-[2px] py-[2px] cursor-pointer rounded-md hover:text-white
					transition-all duration-500 ease-in-out'/>
					<h2 className='px-[10px] text-[20px] text-gray-300
