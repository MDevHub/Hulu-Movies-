   ...
   return (
      <div className='inline-block m-2 md:m-3 cursor-pointer group'>
         <img src={IMAGE_BASE_URL+movie.movie.backdrop_path} 
            className='w-[230px] md:w-[300px] object-cover rounded-2xl
         ...
         <h2 className='mt-1 transition-all md:text-[22px] group-hover:font-bold'>{movie.movie.original_title}</h2>
      </div>
   )
}
